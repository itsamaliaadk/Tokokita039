        ...
        <div class="col-lg-7 mb-5">
            <div class="contact-form">
                ...
                <form name="sentMessage" method="post" action="<?php echo site_url('main/save_reg'); ?>">
                    ...
                    <div class="control-group">
                        <input type="text" id="shipping_address" class="form-control" placeholder="Alamat Pengiriman" required="required" />
                        <p class="help-block text-danger"></p>
                    </div>
                    <div class="control-group">
...
<script>
    $('#shipping_address').change(function() {
        $.ajax({
            type: 'GET',
            url: "<?php echo site_url('main/getCity'); ?>" + "/" + $('#shipping_address').val(),
    ...
    $('#city').change(function() {
        $('#alamat').text($('city option:selected').text());
    });
</script>


<!-- MASIH ERROR YG ALAMAT ADD CART BLM BISA -->